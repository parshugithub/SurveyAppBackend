...
@Entity
@Table(name = "Confrirmation_token_table")
public class ConfirmationToken 
{
	...
	@OneToOne(targetEntity = ClientLogionEntity.class)
    @JoinColumn(nullable = false, name = "id")
	private ClientLogionEntity customer;
	...
	public ClientLogionEntity getCustomer() {
		return customer;
	}
	public void setCustomer(ClientLogionEntity customer) {
	...
	public ConfirmationToken( final ClientLogionEntity customer) {
		super();
		Calendar calendar = Calendar.getInstance();
	...
	public ConfirmationToken(Long token_id, String token, ClientLogionEntity customer, Date createdDate, Date expirdDate) {
		super();
		this.tokenid = token_id;
		this.token = token;
		this.customer = customer;
