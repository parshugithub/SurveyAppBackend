...
@Configuration
@ComponentScan({"com.ncs.doorsystem.controller"})
@EnableWebSecurity
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/client/login","/client/register","/usermanagemet/allusers","/dashboard/allsites","/usermanagemet/createuser","/usermanagemet/getuser"
